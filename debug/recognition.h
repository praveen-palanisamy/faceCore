...
//Update existing face recognition model with the new faces and labels.
// NOTE: Only "FaceRecognizer.LBPH" support updating existing model.
Ptr<FaceRecognizer> updateModelWithNewFaces(const vector<Mat> preprocessedFaces,const vector<int> faceLabels, Ptr<FaceRecognizer> model, const string facerecAlgorithm="FaceRecognizer.LBPH");
